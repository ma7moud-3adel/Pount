<header class="main-header header-style-three">
    <div class="header-style-three__inner">
        <div class="main-logo-box-three header-contact-info3">
            ...
            <div class="text">
                <p>Make a Call</p>
                <h3><a href="tel:123456789">01001018277</a></h3>
            </div>
        </div>
        <!--Start Header Top-->
                            ...
                            <div class="welcome-text">
                                <div class="header-contact-info text-right-rtl">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="text">
                                                <h6><a>المعرض: مول ٢٢ محور مصطفي كامل   التجمع الاول</a></h6>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <nav class="main-menu style3 navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        <li class="dropdown current"><a href="#">الصفحة الرئيسية</a> </li>
                                        <li class="dropdown"><a href="#">الشركة</a>
                                            <ul>
                                                <li><a href="about.html">من نحن</a></li>
                                                <li class="dropdown"><a href="projects-2.html">مشاريعنا</a> </li>
                                                <li><a href="faq.html">اسألة شائعة</a></li>
                                                <li><a href="testimonials.html">اراء</a></li>
                                                <!-- <li><a href="error.html">404 Error page</a></li> -->
                                            </ul>
                                        </li>
                                        <li class="dropdown"><a href="#servises">خدماتنا</a> </li>
                                        <li class="dropdown"><a href="#blogs">اخبار</a></li>
                                        <li class="dropdown"><a href="shop.html">المتجر</a></li>
        ...
        <div class="header-contact-info3">
            ...
            <a href=""><img src="assets/img/logo.png" alt="Awesome Logo" title=""></a>
        </div>
            ...
            <div class="clearfix">
                ...
                <div class="logo float-left">
                    <a href="index.html" class="img-responsive"><img
                            src="assets/img/logo.png" alt="" title=""></a>
                </div>
                <!--Right Col-->
