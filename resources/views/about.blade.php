            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div style="direction: rtl;" class="about-style2__content">
                        ...
                        <div class="inner-content">
                            <div class="text">
                                <p>متخصصون فى صناعة مادة الواجهات مثل ( جرافياتو اكريلك – ماربل – جرانوليت – المادة
                                    الاسمنتية – معجون البلاستيك والسيلر والعديد من المواد التى تخضع للأبحاث والتطوير وفقا
                                    للمواصفات المحلية والدولية .</p>
                            </div>
                            <h5>إليك بعض المميزات التي تجعل باونت للدهانات خيارًا مثاليًا</h5>
                            <ul>
                                <li>
                                    <div class="icon">
                                    ...
                                    <div class="inner-text">
                                        ...
                                        <p>نستخدم أفضل أنواع الدهانات التي تضمن متانة وألوان زاهية تدوم لسنوات طويلة ونحرص
                                            على ان تكون خالية من المواد الضارة</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
                                ...
                                <li>
                                    ...
                                    <div class="inner-text">
                                        <h3>الخبرة</h3>
                                        <p>جميع منتجاتنا وخدماتنا معتمدة من قبل هيئات الجودة العالمية، مما يضمن لك الحصول
                                            على أفضل النتائج </p>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="single-choose-box mar-b-30">
                        <div class="inner">
                            ...
                            <div class="text">
                                ...
                                <p>نستخدم فقط المواد التي تم اختبارها واعتمادها لضمان سلامتها وعدم احتوائها على مواد ضارة
                                    بالصحة أو البيئة</p>
                                <div class="btn-box">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="single-choose-box mar-b-30">
                        <div class="inner">
                            ...
                            <div class="text">
                                <h3>جودة الخامات</h3>
                                <p>نستخدم مواد أولية عالية الجودة تم اختيارها بعناية لضمان متانة الدهانات ومقاومتها للعوامل
                                    الجوية.
                                </p>
                                <div class="btn-box">
                                    <a class="btn-two" href="#">تفاصيل اكثر</a>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="single-choose-box mar-b-30">
                        <div class="inner">
                            ...
                            <div class="text">
                                <h3>سرعة الرد</h3>
                                <p>توفير المعلومات المناسبة، تجنب التعقيدات، استخدام لغة العميل، واتباع القواعد المهنية</p>
                                <div class="btn-box">
                                    <a class="btn-two" href="#">تفاصيل اكثر</a>
                                </div>
                            </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="single-choose-box mar-b-30">
                        <div class="inner">
                            ...
                            <div class="text">
                                <h3>امان وموثوقية</h3>
                                <p>امان وموثوقية لجميع الخامات المستخدمة</p>
                                <div class="btn-box">
                                    <a class="btn-two" href="#">تفاصيل اكثر</a>
                                </div>
                            </div>
                    ...
                    <div class="single-choose-box mar-b-30">
                        <div class="inner">
                            ...
                            <div class="text">
                                ...
                                <p>مشاركة قيمة بين العميل والشركة للحفاظ على تشغيل المنتج أو الخدمة بسلاسة</p>
                                <div class="btn-box">
                                    <a class="btn-two" href="#">تفاصيل اكثر</a>
                                </div>
                            </div>
